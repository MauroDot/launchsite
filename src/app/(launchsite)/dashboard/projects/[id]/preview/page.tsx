...
export default async function ProjectPreviewPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  try { project = await getProject(id); } catch (error) { console.error("Unable to load website preview", { projectId: id, error }); }
